...
1. Check your [Enemy Reaction](#enemy-reactions) - Not all battles need to be fought
2. Check the [Combat Order](#combat-order) - If you do need to fight, determine who strikes first.
3. Research your enemy, read their description carefully. Monster behavior is varied. Plus, knowing the specifics of that monster type might open up a few tactical possibilities.
...
Be mindful of aiming. Some attacks can produce devastating damage, these are known as [critical attacks](#critical-attack), most do normal damage, and some of them are simply [ineffective and miss the target](#attack-accuracy).
...
* A devastating blow, [see *Critical Attack*](#critical-attack)
* Missing your target, [see *Attack Accuracy*](#attack-accuracy)
* You deliver a blow against your opponent, [see *Normal Attack*](#normal-attack)
