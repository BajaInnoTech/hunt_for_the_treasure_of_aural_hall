...
This field guide works as a dungeon preparation pamphlet. You'll find a description of common items and their uses here.
...
Throw a d6, on normal encounters roll against (4-character_level+dungeon_level), on quest encounters roll against (5-character_level+dungeon level); players rolling a 6 always go first, and if you roll a 1 monsters strike first. Against bosses, Bosses always go first.
...
*We actively discourage retreat*, however if you wish to indulge in this behavior, then all characters in the party must roll a successful dex save to run away. Upon failure, your party spends a turn inactive.
...
**poisoned_level**: When you're poisoned, note the *dungeon_level* you're currently at when the creature that poisoned you. This will be your: "*poisoned_level*".
...
Thanfully, this injury is not serious: You can either...
