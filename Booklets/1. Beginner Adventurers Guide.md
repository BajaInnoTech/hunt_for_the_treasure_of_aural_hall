...
* The different booklets that make up the Hunt for the Treasure  of Aural hall available at [our GitHub repository](https://github.com/BajaInnoTech/treasure_of_aural_hall/). Including:
...
* Sheets of paper to map your dungeon (we recommend using grid paper)
...
* *Brownie*: Slightly shorter and leaner than dwarfs, brownies are dexterous when handling locks/traps. They also have a deep bond with animals capable of communicating with them. Brownies can't be healers.

### Classes

*Clerk*: "And these are skills they tend to specialize in:"

* *Fighter*: A warrior is capable of using any weapon/armor they find, and produce extra attacks.
* *Mage*: Versatile casters capable of using defensive/offensive magic as well as scrolls. They have a helpful attunement to magic but are usually fragile.
* *Healer*: Healers are defensive magic specialists, focused mostly on keeping the party healthy though they can also use scrolls. Generally resilient.
* *Rogue*: Capable of deadly tactical maneuvers and able to handle traps, treasure and locks.
...
Characters will level up by correctly completing *Quests*. They must have leveled up 4 times before they can try their hand at finding **The treasure of Aural Hall**. These *Quests* determine the goal of the dungeon crawl and vary from one entry to another.
...
* Purchase bandages & thieves tools. You start out with 5 rations & 5 torches which is indicative of how important these are (make sure to keep stock); all characters need rations to rest, and if you have a brownie in your party they're also helpful in befriending animals. Remember no thief's tools NO TREASURE and traps can't be disarmed without them either!
...
This is the level of your playable character. It starts at 1, and increases each time you finish a quest successfully.
...
* *Encounters*: Your characters strike first.
* *Quest Encounters*: Monsters strike first.
...
Roll a *d6* to determine what that room looks like and chart that location in a sheet of paper (we recommend you use squared paper for this).

###### Determine The Layout And Location Of The Dungeon Exit
