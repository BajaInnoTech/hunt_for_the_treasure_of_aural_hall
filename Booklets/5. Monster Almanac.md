...
* [Encounters](#encounters)
  * [Encounters per level](#encounters-per-level)
    ...
    * [Level 2 Encounters Table](#level-2-encounters-table)
* [Monsters](#monsters)
  * [Bat](#centerbatcenter)
  ...
  * [Orc](#centerorccenter)
  * [Recently Converted Vampire](#centerrecently-converted-vampirecenter)
  * [Skeleton](#centerskeletoncenter)
  * [Spider](#centerspidercenter)
  * [Snake](#centersnakecenter)
  * [Zombie](#centerzombiecenter)
...
#### Level 2 Encounters Table

1. [Minotaur](#centerminotaurcenter)
2. [Black Ooze](#centerblack-oozecenter)
3. [Orc](#centerorccenter)*
4. [Goblin](#centergoblincenter)*
5. [Skeleton](#centerskeletoncenter)
6. [Spider](#centerspidercenter)+
...
<figure>
  <center><img src="../Images/minotaur.png" height="300" alt="A hostile looking minotaur flaunts its axe while keeping a ."></center>
  <i><center><figcaption>The Minotaur seems an equally strong and fierce combatant, this won't be an easy fight.</figcaption></center></i>
</figure>

Mintoaurs are patient and calculating but once they engage they are completely taken over by fury and will never stop attacking unless either its targets or itself are slain. They have *(level+party_size+1)d6* HP and cause *(level+1)d6+level/2* damage. On a roll of *5* or *6*, they perform a charge.

**Lightly Armored:** Minotaurs have *(dungeon_level+1)/2* AC.

<div class="page"/>

**Minotaur Charge**: The Minotaur runs horns first against an opponent, the target must perform a successful *body save* or will be knocked out their (remaining unconscious for one round). When the Minotaur successfully knocks out an opponent, it continues its charge against another target, stopping only upon failure or after having knocked out the entire party, in which case the minotaur attacks all members again (the charge continues while the party is unconscious).
...
### <center>Recently Converted Vampire</center>

<figure>
  <center><img src="../Images/recently-converted-vampire.png" height="300" alt="A recently converted vampire approaches, its hands blurry."></center>
  <i><center><figcaption>This recently converted vampire must have been drained and is determined to restore its blood by draining yours.</figcaption></center></i>
</figure>

Recently converted vampires are weaker than their longer lived brethren (fortunately). However, they still possess many deadly abilities that can put any party in danger.

A recently converted vampire has *2\*((dungeon_level+1)d6)* HP (first roll your d6, then multiply the total by two), and is immune to sedation and sneak attacks.

**Lasting Injuries**: When attacked by a recently converted vampire, roll a body save or lose *1* HP per round for *(dungeon_level+1)* rounds.
...
<figure>
  <center><img src="../Images/zombie.png" height="300" alt="Lifeless corpses stumble in your direction."></center>
  <i><center><figcaption>Zombies are only aware of their hunger.</figcaption></center></i>
</figure>

Zombies should never be underestimated, their threat is in their numbers and their ability to add to them. You are attacked by *(party_size+dungeon_level+1)* *Zombies*. Each zombie has *1d6* HP, but can't be sneak attacked, sedated or compelled by most means since they are mindless.

**Voracious Grip:** On an attack of *4* or more, the player must perform a dex save or be grappled. Once grappled the player receives maximum damage until a successful dex save or another character kills that *Zombie*.

<div class="page"/>

**Assimilating Taint:** Characters slain by *Zombies* immediately rise as *Zombies* themselves attacking other players in that round. One can restore a Zombified character with a raise the dead spell without a need for rolling any save.

**Incompatible With Life:** *Zombies* are immediately neutralized by means of a raise the dead spell, and harmed by curative spells or items.

**Undead**: *Zombies* are undead creatures.
